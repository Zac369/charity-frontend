...
const TokenShop = ({currentAccount, charitiesContract, tokenContract}) => {
    ...
    return (
        <div className="grid place-items-center pt-6">
            <div className="text-center text-xl bg-white px-24 py-4 rounded-3xl pb-5">
                ...
                <div onChange={(e) => setTradeOption(e.target.value)}>
                    <ul className="grid grid-cols-2 gap-x-5 m-8 max-w-sm mx-auto">
                        <li className="relative">
                            ...
                            <label className="inline-block w-40 text-center py-5 text-white bg-gray  rounded-lg cursor-pointer focus:outline-none hover:text-truewhite peer-checked:text-truewhite peer-checked:ring-orange peer-checked:ring-2 peer-checked:border-transparent peer-checked:bg-orange" htmlFor="answer_buy">Buy</label>
                        </li>

                        <li className="relative">
                            <input className="sr-only peer" type="radio" value="sell" name="answer" id="answer_sell"/>
                            <label className="inline-block w-40 text-center py-5 text-white bg-gray  rounded-lg cursor-pointer focus:outline-none hover:text-truewhite peer-checked:text-truewhite peer-checked:ring-orange peer-checked:ring-2 peer-checked:border-transparent peer-checked:bg-orange" htmlFor="answer_sell">Sell</label>
                        </li>
                    </ul>
                </div>

                <div>
                    <p>Conversion Rate: 1 Matic = 10000 Tokens</p>
                    ...
                    <p className="py-5">{selectedTokens / 1} Tokens = {selectedTokens / 10000} Matic</p>
